...
public class GameEngineTest {
    ...
    public void resolveWinner() {
        ...
        connections.get(0).getPlayer().setPoints(31);
        connections.get(1).getPlayer().setPoints(11);
        connections.get(2).getPlayer().setPoints(34);
        connections.get(3).getPlayer().setPoints(31);
        connections.get(4).getPlayer().setPoints(17);

        try {
            gameEngine.getBoard().getKillShotTrack().getKillers().add(connections.get(0).getPlayer());
            gameEngine.getBoard().getKillShotTrack().getKillers().add(connections.get(0).getPlayer());
            gameEngine.getBoard().getKillShotTrack().getKillers().add(connections.get(1).getPlayer());
            gameEngine.getBoard().getKillShotTrack().getKillers().add(connections.get(2).getPlayer());
            gameEngine.getBoard().getKillShotTrack().getKillers().add(connections.get(3).getPlayer());
            gameEngine.getBoard().getKillShotTrack().getKillers().add(connections.get(0).getPlayer());
    ...
    public void resolveDraw() {
        ...
        connections.get(0).getPlayer().setPoints(34);
        connections.get(1).getPlayer().setPoints(11);
        connections.get(2).getPlayer().setPoints(34);
        connections.get(3).getPlayer().setPoints(31);
        connections.get(4).getPlayer().setPoints(17);
