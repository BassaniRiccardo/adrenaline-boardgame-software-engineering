...
public class Updater {
     ...
     * @return              the updated model.
     */
    public static ClientModel getModelObject (Board board, Player player) {
    ...
    public static ClientModel getModel2(Board board, Player player) {ClientModel cm = new ClientModel();
